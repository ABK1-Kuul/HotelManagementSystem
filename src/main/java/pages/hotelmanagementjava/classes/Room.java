...
/**
 * The Room class acts as a data entity representing a hotel room.
 * <p>
 * <b>OOP Principle - Encapsulation:</b>
 * The room state (number, capacity, price, availability) is hidden inside private fields.
 * Public methods (e.g., {@code bookRoom()}) control how the state is mutated, ensuring validity.
 * </p>
 */
public class Room {
